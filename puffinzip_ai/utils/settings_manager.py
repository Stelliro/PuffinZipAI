...
EDITABLE_SETTINGS = {
    ...
    "INITIAL_POPULATION_SIZE": {"type": int, "min": 5, "max": 200, "default": 12, "label": "Initial Population",
                                 "tooltip": "Agents in the first generation of a new run for quick feedback."},
    "POPULATION_GROWTH_STEP": {"type": int, "min": 1, "max": 100, "default": 8, "label": "Population Growth Step",
                                "tooltip": "Number of new agents added when the evolution expands."},
    "POPULATION_GROWTH_INTERVAL": {"type": int, "min": 1, "max": 100, "default": 5,
                                     "label": "Population Growth Interval",
                                     "tooltip": "Generations between automatic population expansions."},
