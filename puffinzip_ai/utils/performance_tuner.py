...
DEFAULT_TUNABLE_PARAMS = {
    ...
    "RLE_THROTTLE_CHUNK_SIZE": 2 * 1024 * 1024,
    "RLE_THROTTLE_SLEEP_DURATION": 0.0,
}

PERFORMANCE_TIERS = {
    "LOW_END": {
        "AGENTS_PER_THROTTLE_CHECK": 10,
        "ITEMS_PER_THROTTLE_CHECK": 50,
        "THROTTLE_SLEEP_DURATION_BENCH_EVAL": 0.0001,
        "RLE_THROTTLE_RUN_LENGTH_THRESHOLD": 2 * 1024 * 1024,
        "RLE_THROTTLE_CHUNK_SIZE": 256 * 1024,
        "RLE_THROTTLE_SLEEP_DURATION": 0.0001,
    },
    "BALANCED": DEFAULT_TUNABLE_PARAMS.copy(),
    "HIGH_END": {
        "AGENTS_PER_THROTTLE_CHECK": 100,
        "ITEMS_PER_THROTTLE_CHECK": 1000,
        "THROTTLE_SLEEP_DURATION_BENCH_EVAL": 0.0,
        "RLE_THROTTLE_RUN_LENGTH_THRESHOLD": 16 * 1024 * 1024,
        "RLE_THROTTLE_CHUNK_SIZE": 4 * 1024 * 1024,
        "RLE_THROTTLE_SLEEP_DURATION": 0.0,
    }
}
